...
def plot_time_series_eq_converge(data, erate, column_names,output_cutoff, use_latex=True, save=False, save_dir="plots"):
    """
...
def plot_time_series_shear_converge(data, erate, column_names,output_cutoff,total_strain, use_latex=True, save=False, save_dir="plots"):
    """
    Plots time series data for each column, showing all timesteps on the same graph.
    Adds mean, std deviation (over last 60%), and gradient stats to legend and stores them in an array.
...
def plot_stats_vs_timestep_log_file(stats_array, timestep, column_names, use_latex=True, gradient_threshold=1e-4, save=False, save_dir="plots"):
    """
...
stats_array_eq=plot_time_series_eq_converge(mean_eq_log_data_array, erate, eq_columns,output_cutoff, use_latex=True, save=False, save_dir="plots")

stats_array_shear=plot_time_series_shear_converge(mean_shear_log_data_array, erate, shear_columns,output_cutoff,total_strain, use_latex=True, save=False, save_dir="plots")



plot_stats_vs_timestep_log_file(stats_array_eq,erate,eq_columns,use_latex=True, gradient_threshold=1e-3, save=False, save_dir="plots" )

plot_stats_vs_timestep_log_file(stats_array_shear,erate,shear_columns,use_latex=True, gradient_threshold=1e-3, save=False, save_dir="plots" )
...
stats_array_shear=plot_time_series_shear_converge(mean_stress_array, erate,stress_columns,output_cutoff,total_strain, use_latex=True, save=False, save_dir="plots")

#%%
plot_stats_vs_timestep_log_file(stats_array_shear,erate,stress_columns,use_latex=True, gradient_threshold=1e-3, save=False, save_dir="plots" )
